...
namespace Training
{
    [SpecialExecutionTaskName("AdvancedBuffer")]
    class BufferWithExplicitName : SpecialExecutionTaskEnhanced
    {
        public BufferWithExplicitName(Validator validator) : base(validator)
        {
        }
